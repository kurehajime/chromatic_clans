...
export default function GameFieldElement(props: Props) {
    ...
    return (<g>
        ...
        {
            // 手札プレイヤー１手札１
            props.fieldSet.Field1.Hand.length > 0 && <CardElement x={XY.player1Hand1x} y={XY.player1Hand1y} card={props.fieldSet.Field1.Hand[0]} player={Player.Player1} />
        }
        {
            // 手札プレイヤー１手札２
            props.fieldSet.Field1.Hand.length > 1 && <CardElement x={XY.player1Hand2x} y={XY.player1Hand2y} card={props.fieldSet.Field1.Hand[1]} player={Player.Player1} />
        }
        {
            // 手札プレイヤー１手札３
            props.fieldSet.Field1.Hand.length > 2 && <CardElement x={XY.player1Hand3x} y={XY.player1Hand3y} card={props.fieldSet.Field1.Hand[2]} player={Player.Player1} />
        }
        {
            // 手札プレイヤー２手札１
            props.fieldSet.Field2.Hand.length > 0 && <CardElement x={XY.player2Hand1x} y={XY.player2Hand1y} card={props.fieldSet.Field2.Hand[0]} player={Player.Player2} />
        }
        {
            // 手札プレイヤー２手札２
            props.fieldSet.Field2.Hand.length > 1 && <CardElement x={XY.player2Hand2x} y={XY.player2Hand2y} card={props.fieldSet.Field2.Hand[1]} player={Player.Player2} />
        }
        {
            // 手札プレイヤー２手札３
            props.fieldSet.Field2.Hand.length > 2 && <CardElement x={XY.player2Hand3x} y={XY.player2Hand3y} card={props.fieldSet.Field2.Hand[2]} player={Player.Player2} />
        }
        {
            // 左側プレイヤー１Stack１
